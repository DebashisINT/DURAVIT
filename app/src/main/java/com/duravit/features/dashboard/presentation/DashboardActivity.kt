...
import com.duravit.*
import com.duravit.ContactUtils.retrieveAllContacts
import com.duravit.R
import com.duravit.app.*
import com.duravit.app.NewFileUtils.browseDocuments
import com.duravit.app.NewFileUtils.getExtension
import com.duravit.app.domain.*
import com.duravit.app.types.DashboardType
import com.duravit.app.types.FragType
import com.duravit.app.types.TopBarConfig
import com.duravit.app.uiaction.DisplayAlert
import com.duravit.app.utils.*
import com.duravit.app.utils.AppUtils.Companion.isProfile
...
import com.duravit.features.NewQuotation.AddQuotFormFragment
import com.duravit.features.NewQuotation.ViewAllQuotListFragment
import com.duravit.features.NewQuotation.ViewDetailsQuotFragment
import com.duravit.features.SearchLocation.SearchLocationFragment
import com.duravit.features.SearchLocation.locationInfoModel
import com.duravit.features.TA.ViewAllTAListFragment
import com.duravit.features.achievement.AchievementFragment
import com.duravit.features.activities.presentation.*
import com.duravit.features.addAttendence.*
...
import com.duravit.features.addorder.presentation.AddOrderFragment
import com.duravit.features.addshop.model.AddShopRequestData
import com.duravit.features.addshop.model.AddShopResponse
import com.duravit.features.addshop.presentation.AddShopFragment
import com.duravit.features.addshop.presentation.OTPVerificationDialog
import com.duravit.features.addshop.presentation.ScanImageFragment
import com.duravit.features.addshop.presentation.ShowCardDetailsDialog
import com.duravit.features.alarm.model.AlarmData
import com.duravit.features.alarm.presetation.AttendanceReportFragment
import com.duravit.features.alarm.presetation.PerformanceReportFragment
import com.duravit.features.alarm.presetation.VisitReportDetailsFragment
import com.duravit.features.alarm.presetation.VisitReportFragment
import com.duravit.features.attendance.AttendanceFragment
import com.duravit.features.attendance.api.AttendanceRepositoryProvider
import com.duravit.features.attendance.model.AttendanceRequest
import com.duravit.features.attendance.model.AttendanceResponse
import com.duravit.features.averageshop.presentation.AverageShopFragment
import com.duravit.features.avgorder.presentation.AverageOrderFragment
import com.duravit.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.duravit.features.beatCustom.TeamBeatListFragment
import com.duravit.features.billing.presentation.AddBillingFragment
import com.duravit.features.billing.presentation.BillingDetailsFragment
import com.duravit.features.billing.presentation.BillingListFragment
import com.duravit.features.changepassword.presentation.ChangePasswordDialog
import com.duravit.features.chat.model.ChatListDataModel
import com.duravit.features.chat.model.ChatUserDataModel
import com.duravit.features.chat.model.GroupUserDataModel
import com.duravit.features.chat.presentation.*
import com.duravit.features.chatbot.presentation.ChatBotFragment
import com.duravit.features.chatbot.presentation.ChatBotShopListFragment
import com.duravit.features.chatbot.presentation.ReportsFragment
import com.duravit.features.chatbot.presentation.SelectLanguageDialog
import com.duravit.features.commondialog.presentation.CommonDialog
import com.duravit.features.commondialog.presentation.CommonDialogClickListener
import com.duravit.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.duravit.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.duravit.features.commondialogsinglebtn.OnDialogClickListener
import com.duravit.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.duravit.features.dailyPlan.prsentation.AllShopListFragment
import com.duravit.features.dailyPlan.prsentation.DailyPlanListFragment
import com.duravit.features.dailyPlan.prsentation.PlanDetailsFragment
import com.duravit.features.damageProduct.ShopDamageProductListFrag
import com.duravit.features.damageProduct.ShopDamageProductSubmitFrag
import com.duravit.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.duravit.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.duravit.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.duravit.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.duravit.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.duravit.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.duravit.features.dashboard.presentation.model.ContentListResponseModel
import com.duravit.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.duravit.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.duravit.features.device_info.presentation.DeviceInfoListFragment
import com.duravit.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.duravit.features.document.DocumentRepoFeatureNewFragment
import com.duravit.features.document.presentation.DocumentListFragment
import com.duravit.features.document.presentation.DocumentTypeListFragment
import com.duravit.features.document.presentation.OpenFileWebViewFragment
import com.duravit.features.dymanicSection.presentation.AddDynamicFragment
import com.duravit.features.dymanicSection.presentation.AllDynamicListFragment
import com.duravit.features.dymanicSection.presentation.DynamicListFragment
import com.duravit.features.dymanicSection.presentation.EditDynamicFragment
import com.duravit.features.gpsDisabilityScreen.GpsDisableFragment
import com.duravit.features.home.presentation.HomeFragment
import com.duravit.features.homelocation.presentation.HomeLocationFragment
import com.duravit.features.homelocation.presentation.HomeLocationMapFragment
import com.duravit.features.know_your_state.KnowYourStateFragment
import com.duravit.features.lead.LeadFrag
import com.duravit.features.lead.ViewLeadFrag
import com.duravit.features.leaveapplynew.LeaveHome
import com.duravit.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.duravit.features.localshops.LocalShopListFragment
import com.duravit.features.localshops.LocalShopListMapFragment
import com.duravit.features.localshops.NearByShopsMapFragment
import com.duravit.features.location.*
import com.duravit.features.location.model.ShopDurationRequest
import com.duravit.features.location.model.ShopDurationRequestData
import com.duravit.features.location.model.ShopRevisitStatusRequest
import com.duravit.features.location.model.ShopRevisitStatusRequestData
import com.duravit.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.duravit.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.duravit.features.login.ShopFeedbackEntity
import com.duravit.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.duravit.features.login.presentation.LoginActivity
import com.duravit.features.logout.presentation.api.LogoutRepositoryProvider
import com.duravit.features.logoutsync.presentation.LogoutSyncFragment
import com.duravit.features.marketing.presentation.MarketingPagerFragment
import com.duravit.features.meetinglist.prsentation.MeetingListFragment
import com.duravit.features.member.MapViewForTeamFrag
import com.duravit.features.member.model.TeamLocDataModel
import com.duravit.features.member.model.TeamShopListDataModel
import com.duravit.features.member.presentation.*
import com.duravit.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.duravit.features.micro_learning.presentation.MicroLearningListFragment
import com.duravit.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.duravit.features.myallowancerequest.MyallowanceRequestFragment
import com.duravit.features.myjobs.model.CustomerDataModel
import com.duravit.features.myjobs.presentation.*
import com.duravit.features.myorder.presentation.MyOrderListFragment
import com.duravit.features.myprofile.presentation.MyProfileFragment
import com.duravit.features.nearbyshops.presentation.BeatListFragment
import com.duravit.features.nearbyshops.presentation.NearByShopsListFragment
import com.duravit.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.duravit.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.duravit.features.newcollection.CollectionDetailsStatusFragment
import com.duravit.features.newcollection.CollectionShopListFragment
import com.duravit.features.newcollection.NewCollectionListFragment
import com.duravit.features.newcollectionreport.*
import com.duravit.features.notification.NotificationFragment
import com.duravit.features.orderList.NewDateWiseOrderListFragment
import com.duravit.features.orderList.NewOrderListFragment
import com.duravit.features.orderList.OrderListFragment
import com.duravit.features.orderdetail.presentation.OrderDetailFragment
import com.duravit.features.orderhistory.ActivityMapFragment
import com.duravit.features.orderhistory.OrderhistoryFragment
import com.duravit.features.orderhistory.TimeLineFragment
import com.duravit.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.duravit.features.orderhistory.model.LocationData
import com.duravit.features.performance.GpsStatusFragment
import com.duravit.features.performance.PerformanceFragment
import com.duravit.features.performance.api.UpdateGpsStatusRepoProvider
import com.duravit.features.performance.model.UpdateGpsInputParamsModel
import com.duravit.features.permissionList.ViewPermissionFragment
import com.duravit.features.photoReg.PhotoAttendanceFragment
import com.duravit.features.photoReg.ProtoRegistrationFragment
import com.duravit.features.photoReg.RegisTerFaceFragment
import com.duravit.features.photoReg.TeamAttendanceFragment
import com.duravit.features.quotation.presentation.*
import com.duravit.features.reimbursement.presentation.EditReimbursementFragment
import com.duravit.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.duravit.features.reimbursement.presentation.ReimbursementFragment
import com.duravit.features.reimbursement.presentation.ReimbursementListFragment
import com.duravit.features.report.presentation.*
import com.duravit.features.returnsOrder.*
import com.duravit.features.settings.presentation.SettingsFragment
import com.duravit.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.duravit.features.shopdetail.presentation.*
import com.duravit.features.shopdetail.presentation.api.EditShopRepoProvider
import com.duravit.features.stock.StockDetailsFragment
import com.duravit.features.stock.StockListFragment
import com.duravit.features.stockAddCurrentStock.AddShopStockFragment
import com.duravit.features.stockAddCurrentStock.UpdateShopStockFragment
import com.duravit.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.duravit.features.stockCompetetorStock.AddCompetetorStockFragment
import com.duravit.features.stockCompetetorStock.CompetetorStockFragment
import com.duravit.features.stockCompetetorStock.ViewComStockProductDetails
import com.duravit.features.survey.SurveyFrag
import com.duravit.features.survey.SurveyViewDtlsFrag
import com.duravit.features.survey.SurveyViewFrag
import com.duravit.features.task.presentation.AddTaskFragment
import com.duravit.features.task.presentation.CalenderTaskFragment
import com.duravit.features.task.presentation.EditTaskFragment
import com.duravit.features.task.presentation.TaskListFragment
import com.duravit.features.timesheet.presentation.AddTimeSheetFragment
import com.duravit.features.timesheet.presentation.EditTimeSheetFragment
import com.duravit.features.timesheet.presentation.TimeSheetListFragment
import com.duravit.features.viewAllOrder.CartFragment
import com.duravit.features.viewAllOrder.OrderTypeListFragment
import com.duravit.features.viewAllOrder.ViewAllOrderListFragment
import com.duravit.features.viewAllOrder.ViewCartFragment
import com.duravit.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.duravit.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.duravit.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.duravit.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.duravit.features.viewPPDDStock.ViewOutstandingFragment
import com.duravit.features.viewPPDDStock.ViewPPDDListFragment
import com.duravit.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.duravit.features.viewPPDDStock.ViewStockFragment
import com.duravit.features.weather.presentation.WeatherFragment
import com.duravit.mappackage.MapActivity
import com.duravit.mappackage.MapActivityWithoutPath
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xduravitlogsample/log").path);
            //27-09-2021
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log.bak.1").path);
...
//        return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
...
//        }
        val bytes = ByteArrayOutputStream()
//        bm!!.compress(Bitmap.CompressFormat.JPEG, 90, bytes)
        var destination = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log")
        val fo: FileOutputStream
        val fo1:FileWriter
        try {
            fo = FileOutputStream(destination)
