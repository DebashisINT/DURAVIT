package com.duravit.features.logoutsync.presentation
...
import com.duravit.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.duravit.features.addshop.api.AddShopRepositoryProvider
import com.duravit.features.billing.api.AddBillingRepoProvider
import com.duravit.features.billing.model.AddBillingInputParamsModel
...
import com.duravit.features.dashboard.presentation.ReasonDialog
...
import com.duravit.features.document.model.AddEditDocumentInputParams
import com.duravit.features.document.model.DocumentAttachmentModel
...
import com.duravit.features.location.model.*
...
import com.duravit.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.duravit.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.duravit.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.duravit.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.duravit.features.orderhistory.model.*
...
import com.duravit.features.quotation.model.AddQuotInputModel
...
import com.duravit.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.duravit.features.stockAddCurrentStock.ShopAddCurrentStockRequest
import com.duravit.features.stockAddCurrentStock.api.ShopAddStockProvider
import com.duravit.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.duravit.features.timesheet.model.AddTimeSheetInputModel
import com.duravit.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.duravit.features.viewAllOrder.model.AddOrderInputParamsModel
import com.duravit.features.viewAllOrder.model.AddOrderInputProductList
...
import com.duravit.features.addshop.model.assigntopplist.AddShopUploadImg
import com.duravit.features.login.api.LoginRepositoryProvider
import com.duravit.features.login.model.GetConcurrentUserResponse
import com.duravit.features.returnsOrder.ReturnProductList
import com.duravit.features.returnsOrder.ReturnRequest
...
//            checkToCallActivity()
 ...
 /* private fun callLogshareApi(){
    ...
    private fun callLogshareApi(){
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log.zip").path))).use { out ->
                ...
                val addReqData = AddLogReqData()
                addReqData.user_id = Pref.user_id
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xduravitlogsample/log.zip").path);
                val file = File(fileUrl.path)
                if (!file.exists()) {
                    checkToCallActivity()
                }
